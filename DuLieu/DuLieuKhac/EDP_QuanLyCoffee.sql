...
--SELECT CONVERT(DATE, ngayLap, 103), SUM([tongTien]) AS TongTien 
--FROM HoaDon 
...
--SET @TuNgay = '22/3/2024'
--SET @DenNgay = '24/4/2024'
--SELECT CONVERT(DATE, @TuNgay, 103), CONVERT(DATE, GETDATE(), 103)

SELECT SP.maSP, SP.tenSP, COUNT(CT.maSP) AS Count
