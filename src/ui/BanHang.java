...
public class BanHang extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnTrangChu = new ui.MyButton();
        btnBanHang = new ui.MyButton();
        btnHoaDon = new ui.MyButton();
        btnSanPham = new ui.MyButton();
        btnThongKe = new ui.MyButton();
        btnNhanVien = new ui.MyButton();
        jPanelControl = new javax.swing.JPanel();
        l_date = new javax.swing.JLabel();
        l_time = new javax.swing.JLabel();
        btnDMK = new ui.MyButton();
        btnDXuat = new ui.MyButton();
        btnGiaoCa = new ui.MyButton();
...
//        lblHinh.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GD/img/baalBTL.png"))); // NOI18N
    ...
    private ui.MyButton btnBanHang;
    private ui.MyButton btnDMK;
    private ui.MyButton btnDXuat;
    private ui.MyButton btnGiaoCa;
    private ui.MyButton btnHoaDon;
    private ui.MyButton btnNhanVien;
    private ui.MyButton btnSanPham;
    private ui.MyButton btnThongKe;
    private ui.MyButton btnTrangChu;
